...
export default async function DashboardPage() {
  ...
  return <main className="dashboard-shell">
    <aside className="dashboard-sidebar">
      ...
      <nav aria-label="Navigasi editorial"><a className="nav-active" href="#overview">Overview</a><a href="#notifications">Notifikasi</a><a href="#write">Tulis artikel</a><a href="#taxonomy">Kategori & tag</a><a href="#workflow">Workflow</a></nav>
